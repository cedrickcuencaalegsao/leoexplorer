...
/// Generated: 2026-06-28T12:19:07.874560+00:00
/// Collection: solar
/// This is a partial import from Iconify
/// Browse icons: <https://icon-sets.iconify.design/solar/>
///
/// ```yaml
/// name: Solar
/// author:
...
pub const ArrowLeftBroken: IconData = IconData {
    name: "solar:arrow-left-broken",
    body: r#"<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="m4 12l6-6m-6 6l6 6m-6-6h10.5m5.5 0h-2.5"/>"#,
    view_box: "0 0 24 24",
    width: "24",
    height: "24",
};
...
#[allow(non_upper_case_globals)]
pub const ArrowRightBroken: IconData = IconData {
    name: "solar:arrow-right-broken",
    body: r#"<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M4 12h2.5M20 12l-6-6m6 6l-6 6m6-6H9.5"/>"#,
    view_box: "0 0 24 24",
    width: "24",
    height: "24",
};
