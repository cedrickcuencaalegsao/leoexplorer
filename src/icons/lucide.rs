...
/// Generated: 2026-06-29T12:44:39.629232+00:00
/// Collection: lucide
...
#[allow(non_upper_case_globals)]
pub const Logs: IconData = IconData {
    name: "lucide:logs",
    body: r#"<path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5h1m-1 7h1m-1 7h1M8 5h1m-1 7h1m-1 7h1m4-14h8m-8 7h8m-8 7h8"/>"#,
    view_box: "0 0 24 24",
    width: "24",
    height: "24",
};
